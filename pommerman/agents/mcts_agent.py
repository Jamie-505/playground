...
class MCTSAgent(BaseAgent):
    ...
    def rollout(self):
        ...
        while not done:
            ...
            length += 1
            print("Agent:", self.agent_id, "Step:", length, "Actions:", [constants.Action(a).name for a in actions],
                  "Probs:", [round(p, 2) for p in pi], "Rewards:", rewards, "Done:", done)
...
if __name__ == "__main__":
    ...
    for i in range(args.num_episodes):
        ...
        print("Episode:", i, "Reward:", reward, "Length:", length, "Rewards:", rewards, "Agent:", agent_id,
              "Time per step:", elapsed / length)
